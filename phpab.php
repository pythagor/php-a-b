...
class phpab
{
    ...
    public function __construct($n, $t = FALSE)
    {
        if ($this->detect_bots == TRUE) {
            $bots = ['googlebot', 'msnbot', 'slurp', 'ask jeeves', 'crawl', 'ia_archiver', 'lycos'];
    ...
    public function add_variation($n, $v = '')
    {
        ...
        array_push($this->variations, ['name' => $n, 'value' => $v]);
    }
    ...
    public function get_user_segment()
    {
        ...
        array_unshift($this->variations, ['name' => 'control', 'value' => '']);
